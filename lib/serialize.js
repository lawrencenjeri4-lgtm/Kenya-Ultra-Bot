...
console.log("Owner Number :", config.owner.number);
...
// (pulled from contextInfo, whichever message type carries it)
// ==========================
...
if (contextInfo.quotedMessage) {
    ...
    m.quoted = {
        ...
        download: async () => {
            ...
            const stream = await downloadContentFromMessage(
                contextInfo.quotedMessage[quotedType],
